...
/*
 * PhyloCompare.java Copyright (C) 2026 Daniel H. Huson
 *
...
public class PhyloCompare extends Application {
    ...
    public static void main(String[] args) {
        ...
        ProgramProperties.getProgramIconsFX().setAll(Utils.getImage(PhyloCompare.class, "PhyloCompare-512x512.png"));
        ...
        SplashScreen.setImage(Utils.getImage(PhyloCompare.class, "PhyloCompare-Splash.png"));
    ...
    protected static void parseArguments(String[] args) throws UsageException {
        var options = new ArgsOptions(args, PhyloCompare.class, "Run the PhyloCompare on a collection of trees");
        ...
        if (showVersion) {
            ...
            System.err.println(jloda.util.Version.getVersion(PhyloCompare.class, ProgramProperties.getProgramName()));
    ...
    public static String getDefaultPropertiesFile() {
        if (ProgramProperties.isMacOS())
            return System.getProperty("user.home") + "/Library/Preferences/PhyloCompare.def";
        else
            return System.getProperty("user.home") + File.separator + ".PhyloCompare.def";
    }
}
